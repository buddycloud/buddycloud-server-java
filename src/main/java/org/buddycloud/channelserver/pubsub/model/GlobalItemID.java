...
/**
 * Pointer to a globally identifiable node item, using a service JID, node ID and itemID. The Item
 * is unique within the Node The Node is unique within the Service The Service is unique within the
 * network.
 */
