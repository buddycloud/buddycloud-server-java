...
public class OutQueueConsumer extends QueueConsumer {
    ...
    public OutQueueConsumer(ChannelsEngine component, BlockingQueue<Packet> outQueue, FederatedQueueManager federatedQueue, Configuration conf,
    ...
    /**
     * Returns true if the JID points to a server (with no node) and if it is not one of the local
     * domains.
     * 
     * @param jid
     * @return
    ...
    /**
     * Returns <code>true</code> if the jid should route through to this component.
     * 
     * @param jid
     * @return
     */
