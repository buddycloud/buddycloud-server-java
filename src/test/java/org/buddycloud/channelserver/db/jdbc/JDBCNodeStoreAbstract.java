...
public abstract class JDBCNodeStoreAbstract {
	...
	protected static final JID TEST_SERVER1_CHANNELS_JID = new JID(
			"channels.server1");
	protected static final JID TEST_SERVER2_CHANNELS_JID = new JID(
			"channels.server2");

	protected static final JID TEST_SERVER1_USER1_JID = new JID("user1@server1");
	protected static final JID TEST_SERVER1_USER1_JID_WITH_RESOURCE = new JID(
	...
	public JDBCNodeStoreAbstract() throws SQLException, IOException,
	...
	protected void assertNodeConfigEquals(final String nodeId,
