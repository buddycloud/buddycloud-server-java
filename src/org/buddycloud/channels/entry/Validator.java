package org.buddycloud.channels.entry;
...
import org.buddycloud.channels.Main;
...
public class Validator {
	...
	public Validator(Element entry) {
		this.entry = entry;
	}
	...
	public boolean isValid() {
		...
		if(id == null || id.getText().isEmpty()) {
			//this.errorMsg = "Mandatory element ID is missing or empty.";
			//return false;
		...
		if(title == null) {
			//this.errorMsg = "Mandatory element title is missing.";
			//return false;
		...
		if(updated == null) {
			//this.errorMsg = "Mandatory element updated is missing.";
			//return false;
...
//		Element author = this.entry.element("author");
//		if(author == null) {
//			this.errorMsg = "Mandatory element author is missing.";
//			return false;
//		}
//		
//		Element name = author.element("name");
//		if(name == null) {
//			this.errorMsg = "Mandatory element author/name is missing.";
//			return false;
//		}
