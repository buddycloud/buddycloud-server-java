...
/**
 * <presence to="channels.surevine.com" from="lloyd.watkin@surevine.com/resource">
 * <status>buddycloud</status> <show>na</show> <priority>-1</priority> </presence>
 */
public class PresenceProcessorTest extends IQTestHandler {
    ...
    public void testExceptionThrownOnInstantiationIfConfigurationNotSetProperly() throws Exception {
    ...
    public void testNoFromAddressResultsInNoActions() throws Exception {
        ...
        Mockito.verify(onlineUsers, Mockito.times(0)).updateStatus(Mockito.any(JID.class), Mockito.anyString());
    }
    ...
    public void testFromAddressForExternallyValidatedServer() throws Exception {
        ...
        Mockito.verify(onlineUsers, Mockito.times(1)).updateStatus(Mockito.any(JID.class), Mockito.anyString());
    }
    ...
    public void testAcceptablePresencePacketCausesActionsOnResourceManager() throws Exception {
        ...
        Mockito.verify(onlineUsers, Mockito.times(1)).updateStatus(Mockito.any(JID.class), Mockito.isNull(String.class));
    }
}
