...
public class JDBCNodeStoreRecentItemsTest extends JDBCNodeStoreAbstract {
	...
	public JDBCNodeStoreRecentItemsTest() throws SQLException, IOException,
	...
	public void testGetRecentItems() throws Exception {
		...
		CloseableIterator<NodeItem> items = store.getRecentItems(
				TEST_SERVER1_USER1_JID, since, -1, -1, null, null, false);
	...
	public void testGetRecentItemsCanBePaged() throws Exception {
		...
		CloseableIterator<NodeItem> items = store.getRecentItems(
				...
				new GlobalItemIDImpl(TEST_SERVER1_CHANNELS_JID,
						TEST_SERVER1_NODE1_ID, "124"), null, false);
	...
	public void testGetRecentItemsWithNoResultsPerNodeRequestedReturnsExpectedCount()
		...
		CloseableIterator<NodeItem> items = store.getRecentItems(
				TEST_SERVER1_USER1_JID, since, 0, -1, null, null, false);
	...
	public void testCanPageGetRecentItemsUsingResultSetManagement()
		...
		CloseableIterator<NodeItem> items = store.getRecentItems(
				TEST_SERVER1_USER1_JID, since, -1, 10, itemID, null, false);
	...
	public void settingParentOnlyOnlyReturnsThreadParentsForGetRecentItems() throws Exception {
		...
		CloseableIterator<NodeItem> items = store.getRecentItems(
				TEST_SERVER1_USER1_JID, since, -1, -1, null, null, true);
	...
	public void settingParentOnlyReturnsThreadParentsForGetRecentItemsCount() throws Exception {
		...
		int itemCount = store.getCountRecentItems(
				TEST_SERVER1_USER1_JID, since, -1, null, true);
