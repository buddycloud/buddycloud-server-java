...
public class NodeSubscription implements DBObject {
    ...
    public NodeSubscription(String bareJID, String node, String aff, String subs, String foreignChannelServer) {
        sub.put("node", node);
