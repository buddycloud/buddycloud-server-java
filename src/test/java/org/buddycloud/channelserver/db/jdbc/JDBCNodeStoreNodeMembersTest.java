...
public class JDBCNodeStoreNodeMembersTest extends JDBCNodeStoreAbstract {
    ...
    public void getNodeMemberships() throws Exception {
        ...
        HashSet<NodeMembership> expected = new HashSet<NodeMembership>() {
            {
                add(new NodeMembershipImpl(TEST_SERVER1_NODE1_ID, TEST_SERVER2_USER3_JID, TEST_SERVER2_CHANNELS_JID, Subscriptions.subscribed,
                        Affiliations.member, null));
                add(new NodeMembershipImpl(TEST_SERVER1_NODE1_ID, TEST_SERVER1_OUTCAST_JID, Subscriptions.subscribed, Affiliations.outcast, null,
                        new Date()));
                add(new NodeMembershipImpl(TEST_SERVER1_NODE1_ID, TEST_SERVER2_USER1_JID, TEST_SERVER2_CHANNELS_JID, Subscriptions.subscribed,
                        Affiliations.publisher, null, new Date()));
                add(new NodeMembershipImpl(TEST_SERVER1_NODE1_ID, TEST_SERVER1_USER2_JID, Subscriptions.subscribed, Affiliations.publisher, null,
                        new Date()));
    ...
    public void canGetNodeMembershipWhereTheresOnlySubscription() throws Exception {
        ...
        NodeMembership expected =
                new NodeMembershipImpl(TEST_SERVER1_NODE1_ID, TEST_SERVER2_USER3_JID, TEST_SERVER2_CHANNELS_JID, Subscriptions.subscribed,
                        Affiliations.member, null);
    ...
    public void getNodeMembershipReturnsInvitedByDetails() throws Exception {
        ...
        NodeSubscription newSubscription =
                new NodeSubscriptionImpl(TEST_SERVER1_NODE1_ID, TEST_SERVER1_USER1_JID, Subscriptions.invited, TEST_SERVER2_USER2_JID);
