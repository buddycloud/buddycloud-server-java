...
public class ItemDeleteTest extends IQTestHandler {
    ...
    @Test
    public void testProvidingNodeWhichDoesntExistReturnsError() throws Exception {
        Mockito.when(channelManager.isLocalNode(node)).thenReturn(true);
    ...
    @Test
    public void testItemWhichDoesntExistReturnsItemNotFoundError() throws Exception {
        Mockito.when(channelManager.isLocalNode(node)).thenReturn(true);
        Mockito.when(channelManager.nodeExists(node)).thenReturn(true);
    ...
    @Test
    public void testRequestingNotificationsSendsRetractionNotifications() throws Exception {
